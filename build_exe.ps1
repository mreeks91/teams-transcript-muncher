...
Write-Host "  Share TeamsMuncher.zip - unzip and run TeamsMuncher.exe"
Write-Host ""
Write-Host "First run on a new machine: click Sign In to authenticate."
Write-Host "Subsequent runs go straight to the fetch screen."
